    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>Enterprise Management System</h2></a>
            ...
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>Database Performance Analyzer</h2></a>
            ...
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>Microservices Architecture Platform</h2></a>
            ...
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>REST API Development Framework</h2></a>
            ...
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>European R&D Data Management System</h2></a>
            ...
            <div className="project">
                ...
                <a href="#" target="_blank" rel="noreferrer"><h2>Software Architecture Documentation Tool</h2></a>
